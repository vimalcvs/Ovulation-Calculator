...
public class GeneralBlogAdapter extends RecyclerView.Adapter<GeneralBlogAdapter.ViewHolder> {
    ...
    public class HorizontalViewHolder extends ViewHolder {
        ...
        public HorizontalViewHolder(View view) {
            ...
            this.forYouTv = view.findViewById(R.id.forYouTv);
            this.blogCoverImg = view.findViewById(R.id.blogCoverImg);
            this.blogTitleTv = view.findViewById(R.id.blogTitleTv);
            this.blogDescTv = view.findViewById(R.id.blogDescTv);
            this.bottomBlogArea = view.findViewById(R.id.bottomBlogArea);
        }
    }
