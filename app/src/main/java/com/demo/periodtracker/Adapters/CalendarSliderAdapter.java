...
public abstract class CalendarSliderAdapter extends RecyclerView.Adapter<CalendarSliderAdapter.DateViewHolder> {
    ...
    private final int mMiddlePosition;
    ...
    public void onBindViewHolder(DateViewHolder dateViewHolder, final int i) {
        ...
        dateViewHolder.itemView.setOnClickListener(view -> CalendarSliderAdapter.this.m122x61915e3d(i, view));
    }
    ...
    public class DateViewHolder extends RecyclerView.ViewHolder {
        ...
        public DateViewHolder(View view) {
            super(view);
            this.dateTv = view.findViewById(R.id.dateTv);
            this.dayTv = view.findViewById(R.id.dayTv);
            this.cardView = view.findViewById(R.id.cardView);
            this.dateTvBg = view.findViewById(R.id.dateTvBg);
        }
