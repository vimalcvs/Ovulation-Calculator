...
import com.demo.periodtracker.Adapters.CategoryBlogsAdapter;
import com.demo.periodtracker.Model.BlogCategory;
import com.demo.periodtracker.Model.CategoryFeaturedBlog;
import com.demo.periodtracker.R;
import com.demo.periodtracker.Utils.Utils;
import com.demo.periodtracker.databinding.FragmentCategoryBlogsBinding;
...
public class CategoryBlogsFragment extends Fragment {
    ...
    private void showCombinedData() {
        ...
        binding.articlesRecycler.setAdapter(new CategoryBlogsAdapter(arrayList, getActivity()));
    }
    ...
    private void showSeparateData() {
        ...
        while (true) {
            ...
            if (i < strArr.length) {
                ...
                String sb = "en_" + str +
                        ".json";
                List<HashMap<String, Object>> readAssetFile2 = Utils.readAssetFile(context2, sb);
                if (readAssetFile != null && readAssetFile2 != null) {
