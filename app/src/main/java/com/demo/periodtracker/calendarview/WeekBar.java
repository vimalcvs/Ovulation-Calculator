 ...
 */
package com.demo.periodtracker.calendarview;
...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.demo.periodtracker.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.demo.periodtracker.WeekBar".equalsIgnoreCase(getClass().getName())) {
