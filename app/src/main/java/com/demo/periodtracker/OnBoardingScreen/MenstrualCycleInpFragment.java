...
public class MenstrualCycleInpFragment extends Fragment {
    ...
    public void m143x9c48bafd(View view) {
        ...
        inputActivity.cyclesLength = Integer.parseInt(binding.cycleLengthInp.getText().toString());
        ((ViewPager2) inputActivity.findViewById(R.id.viewPager)).setCurrentItem(1, true);
    }


    public void m144xdc73a1be(View view) {
        if (Integer.parseInt(binding.cycleLengthInp.getText().toString()) < 40) {
            binding.cycleLengthInp.setText(String.valueOf(Integer.parseInt(binding.cycleLengthInp.getText().toString()) + 1));
        } else {
            binding.cycleLengthInp.setText(String.valueOf(20));
        }
    }


    public void m145x1c9e887f(View view) {
        if (Integer.parseInt(binding.cycleLengthInp.getText().toString()) > 20) {
            binding.cycleLengthInp.setText(String.valueOf(Integer.parseInt(binding.cycleLengthInp.getText().toString()) - 1));
        } else {
            binding.cycleLengthInp.setText(String.valueOf(40));
        }
    }
}
